...
## Interaction data
pinnrev <- read_csv("../../Data/scoping_data_extraction_20230112.csv") %>% 
...
ggsave(fig2, filename = "../../Figures/extraction_20230112/meta_analysis_summary.pdf",
...
ggsave((fig_3a + fig_3b)/ (fig_3c + fig_3d), filename = "../../Figures/extraction_20230112/fig3.jpeg",
